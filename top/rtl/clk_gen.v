...
module clk_gen (
	...
	// チップリセット
	/* chip_reset was set ENABLE while reset signal was ENABLE 
	 *  OR while the lock signal was DISABLE which means clk_ now was not satisfied
	 *  with the timing phase generated by dcm (a PLL circute), it is easy to
	 *  understand that chip should be set as DISABLE while the clk signal was not
	 *  stable yet. */
